...
<br> ![](../paper_screenshots/nvila/6.png) <br>
...
<br> ![](../paper_screenshots/nvila/7.png) <br>
...
* FA2, and DeepSpeed.
* Implements functional-preserving, on-the-fly sequence packing to fuse samples with different lengths leading to an approximate 30% speedup.
128 NVIDIA H100 GPUs with a global batch size of 2048 across all stages.
* AdamW with no weight decay
* Cosine learning schedule with a linear warmup of 3% of the schedule

<br> ![](../paper_screenshots/nvila/8.png) <br>


# Results

<br> ![](../paper_screenshots/nvila/9.png) <br>