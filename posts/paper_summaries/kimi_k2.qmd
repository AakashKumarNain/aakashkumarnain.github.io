...
- Same policy optimization as in Kimi-1.5. For each problem $x$, sample $K$ responses from the previous policy $π_{old}$, and optimize the model $π_θ$ with respect to the following objective:<br>![](../paper_screenshots/kimi_k2/6.png)
