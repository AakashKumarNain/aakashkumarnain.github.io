...
Sinusoidal encoding was proposed in the paper [Attention is All You Need](https://arxiv.org/abs/1706.03762).
They proposed to generate $p_i$ in the above equation using the sinusoidal function:
$$
\begin{cases}
