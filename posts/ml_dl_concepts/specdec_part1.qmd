...
*Note: The midpoint distribution $M(x)$ is a construction used to define $D_{LK}$ in a way that makes the symmetry between $p$ and $q$ obvious. As we will show below, $D_{LK}$ reduces to the total variation distance $\sum_x \frac{|p(x) - q(x)|}{2}$, and $M(x)$ never appears again in any subsequential result.* <br>
